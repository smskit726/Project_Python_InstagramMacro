...
#   지정한 구문을 사용하여 항묵을 배치하고 처리하는 방법을 기술하는 언어
...
# 3. HashTag Searching
time.sleep(2)
hash_url = 'https://www.instagram.com/explore/tags/%ED%97%A4%EC%9D%B4%EC%A6%88/'
driver.get(hash_url)

# 4. Board List Input & Output
def parse(page_code):
    soup = BeautifulSoup(page_code,'html.parser')
    feed_list = soup.findAll('div', {'class','v1Nh3'}) # class값은 수시로 변경됨(실행할 때 수정)
