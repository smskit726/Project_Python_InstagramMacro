# * chapter04.facebook_login.py
# * : Selenium을 이용해서 페이스북 로그인
# * : 지속적으로 사용 불가능... 페이스북이 보안을 위해 로그인버튼의 선택자를 수시로 변경함 OTL...
# *
...
driver.find_element_by_id('email').send_keys('')  # ID 입력
driver.find_element_by_id('pass').send_keys('')  # password 입력
